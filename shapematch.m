function [target_roi] = shapematch(vidDevice)
...
%   $Revision: 1.1.6.6 $  $Date: 2012/10/29 19:42:28 $
...
hVideoSrc = imaq.VideoDevice('gige', 1, 'Mono8', ...
...
[Img, numberOfTargets, target_image] = ...
  videopattern_gettemplate1(useDefaultTarget);
...
% after 250 frames. Develop something to terminate the program by keyboard.
count = 0;
countlimit= 250;
while count<countlimit
    Im = rgb2gray(step(hVideoSrc));
...
%
% * <matlab:edit('videopattern_gettemplate1.m') videopattern_gettemplate.m>
% * <matlab:edit('videopatternplots1.m') videopatternplots.m>
